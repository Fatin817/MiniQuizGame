...
public class Quiz implements ActionListener{
	...
	public Quiz() {
		...
		buttonD.setText("D");
                ...
                buttonE.setBounds(0,550,160,50);
		buttonE.setFont(new Font("Areial",Font.BOLD,25));
		buttonE.setFocusable(true);
		buttonE.addActionListener(this);
		buttonE.setText("Play Again");
		...
		number_right.setEditable(false);
                ...
                a.setBounds(0,500,500,100);
		a.setForeground(new Color(25,25,25));
		a.setFont(new Font("Areial",Font.PLAIN,45));
		a.setText("Name");
